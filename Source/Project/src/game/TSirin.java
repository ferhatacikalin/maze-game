 ...
 * @author WE
 */
public class TSirin extends OyuncuSinifi {

    int birim = 1;

    public TSirin(int ID, String Ad, int x, int y) {
        super(ID, Ad, x, y);
        setIcon(new ImageIcon("src/game/tembel.png"));
        tur = OyuncuSinifi.OyuncuTur.TSirin;
    }
